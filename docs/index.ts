                    ...
                    <div class="card-content">
                        <div style="display: grid; grid-template-columns: 1fr 1fr 1fr; gap: 15px; font-size: 14px;">
                            ...
                            <div>
                                ...
                                <div><strong>Stop Loss:</strong> ₹${detailedPosition.stopLoss.toFixed(2)}${activePosition?.isTrailingActive ? ' 🛡️ @COST' : ''}</div>
                                <div><strong>Target:</strong> ₹${detailedPosition.target.toFixed(2)}</div>
                                ${!activePosition?.isTrailingActive && activePosition?.trailingTrigger ? `<div style="font-size: 12px; color: #f59e0b; margin-top: 4px;">📊 60% Trail: ₹${activePosition.trailingTrigger.toFixed(2)}</div>` : ''}
                            </div>
                            <div>
                    ...
                    <div style="background: rgba(255,255,255,0.03); border-radius: 12px; padding: 20px; border-left: 4px solid ${(detailedPosition.unrealizedPnL || 0) >= 0 ? '#22c55e' : '#ef4444'};">
                        ...
                        <div style="display: grid; grid-template-columns: repeat(3, 1fr); gap: 20px;">
                            ...
                            <div>
                                ...
                                <div style="color: #94a3b8; font-size: 0.85rem; margin-bottom: 6px;">Stop Loss: <span style="color: #ef4444; font-weight: 600;">₹${detailedPosition.stopLoss.toFixed(2)}</span>${activePosition?.isTrailingActive ? ' <span style="color: #22c55e; font-weight: 700;">🛡️ PROTECTED</span>' : ''}</div>
                                ...
                                ${!activePosition?.isTrailingActive && activePosition?.trailingTrigger ? `<div style="color: #f59e0b; font-size: 0.8rem; margin-top: 6px; padding: 4px 8px; background: rgba(251, 191, 36, 0.1); border-radius: 4px; border-left: 2px solid #f59e0b;">📊 60% Trail Trigger: ₹${activePosition.trailingTrigger.toFixed(2)}</div>` : ''}
                                ${activePosition?.isTrailingActive ? `<div style="color: #22c55e; font-size: 0.8rem; margin-top: 6px; padding: 4px 8px; background: rgba(34, 197, 94, 0.1); border-radius: 4px; border-left: 2px solid #22c55e;">✅ Trade Protected at Cost (Trailed at ${activePosition.trailedAt ? new Date(activePosition.trailedAt).toLocaleTimeString() : 'N/A'})</div>` : ''}
                            </div>
                            <div>
