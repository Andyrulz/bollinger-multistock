...
### Phase 6: End of Day (3:06 PM - 3:41 PM)

| Time        | Event                | Description                                                  |
| ----------- | -------------------- | ------------------------------------------------------------ |
| **3:06 PM** | **Entry Cutoff**     | New entries blocked; pending pullback/FVG states cleared     |
| **3:11 PM** | **EOD Safety Exit**  | All open option positions force-closed                       |
| **3:15 PM** | **Cash CTS Ends**    | F&O-stock underlyings enter the closing auction process      |
| **3:40 PM** | **Derivatives Close**| Continuous F&O trading ends                                  |
| **3:41 PM** | **Cache Cleanup**    | Scanner and slot state reset for the next session            |

**Why 3:11 PM, not 3:25 PM?**

- Zerodha broker auto-squareoff happens at 3:25 PM
- Bot exits before the underlying continuous session ends at 3:15 PM
- The 14-minute broker buffer leaves time for limit-order cancellation and retry
...
| -------- | ---------------------- | ---------------------------------------------- | -------------------------------- |
| 1        | EOD Safety             | Time = 3:11 PM IST                             | Force exit before CAS            |
...
#### Layer 1: EOD Safety Exit (3:11 PM IST)

```
Non-negotiable force exit at 3:11 PM IST
...
| EOD safety exit         | 15:11 (3:11 PM IST)    | Force close all positions before CAS         |
